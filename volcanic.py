...
# we assume first column contains names, then the full profile, but this
...
# We expect the last field of a profile is the reaction \DeltaG
...
if ok:
    ...
    plot_lsfer(idx, d, tags, coeff, cb, verb)
